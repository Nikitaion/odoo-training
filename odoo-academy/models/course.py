...
#
#     age = fields.Integer(
#         compute='_compute_student_age')  # Every time when we обращаемся to field - it compute on backand
#
...
#         # [1, 12, 14]
#         self.teacher_ids = [(0, 0, {'name': 'Teacher A',
#                                     'student_id': self.id})]  # (0, 0, values) - add a newly created record (15)
#         # [1, 12, 14, 15]
#         self.teacher_ids = [(1, 14, {'name': 'Teacher B',
#                                      'student_id': self.id})]  # (1, id, values)  Rename teacherA(id 14) to teacherB. If no id 14 - Exceptiopn
#         # [1, 12, 14, 15]
